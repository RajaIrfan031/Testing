...
class VerifyAccount extends Component {
  ...
  async verfyCode() {
    ...
    {
      //    await console.log('CONFIRm ssssss',this.state.ConfirmResult)
      //  await  console.log('CONFIRm result in',this.state.vCode)
      await this.state.ConfirmResult && this.state.vCode
        ? this.state.ConfirmResult.confirm(this.state.vCode)
            .then(async user => {
              console.log('USER IN CONFIRM',phoneNo);
              try {
                if (user) {
                  ...
                  //console.log('Your Verification Code is Wrong.');
    ...
    return (
      <SafeAreaView
        ...
        <OTPInputView
          ...
          pinCount={6}
          // code={this.state.vCode} //You can supply this prop or not. The component will be used as a controlled / uncontrolled component respectively.
          onCodeChanged={code => {
