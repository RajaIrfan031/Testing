...
import StartedTaskComponent from '../../components/TasksComponent/StartedTaskComponent';
...
class StartedTasksScreen extends Component{
    ...
    return (
        <SafeAreaView style={styles1.homeMenuStyle}>
          ...
          { !this.state.isLoading && this.state.jobSet ?
              <StartedTaskComponent remainingTasks={this.state.assignedTasks} totalSubTimer={this.state.totalSubTimer}/>
                    :
...
export default StartedTasksScreen;